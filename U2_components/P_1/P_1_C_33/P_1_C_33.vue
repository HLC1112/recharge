<template>
  ...
  <div :style="componentStyle" :class="containerClasses">
    ...
    <span class="plane-title-text">前端API</span>
...
import { IProps, IEmits, INode } from './P_1_C_33_inside_Obj';

import { useControl } from './P_1_C_33_control';

import { useComponentStyles } from './P_1_C_33_inside_UI';

import { useContainer, getNodeClasses } from './P_1_C_33_inside_utils';
