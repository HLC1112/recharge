<template>
  ...
  <div :style="componentStyle" :class="containerClasses">
    ...
    <span class="plane-title-text">UF STORE</span>
...
import { IProps, IEmits, INode } from './P_1_C_29_inside_Obj';

import { useControl } from './P_1_C_29_control';

import { useComponentStyles } from './P_1_C_29_inside_UI';

import { useContainer, getNodeClasses } from './P_1_C_29_inside_utils';
