<template>
  ...
  <div :style="componentStyle" :class="containerClasses">
    ...
    <span class="plane-title-text">MongoDB读取数据库</span>
...
import { IProps, IEmits, INode } from './P_1_C_43_inside_Obj';

import { useControl } from './P_1_C_43_control';

import { useComponentStyles } from './P_1_C_43_inside_UI';

import { useContainer, getNodeClasses } from './P_1_C_43_inside_utils';
