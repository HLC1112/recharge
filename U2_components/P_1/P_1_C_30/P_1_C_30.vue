<template>
  ...
  <div :style="componentStyle" :class="containerClasses">
    ...
    <span class="plane-title-text">UI STORE</span>
...
import { IProps, IEmits, INode } from './P_1_C_30_inside_Obj';

import { useControl } from './P_1_C_30_control';

import { useComponentStyles } from './P_1_C_30_inside_UI';

import { useContainer, getNodeClasses } from './P_1_C_30_inside_utils';
