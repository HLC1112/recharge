<template>
  ...
  <div :style="componentStyle" :class="containerClasses">
    ...
    <span class="plane-title-text">后端事件</span>
...
import { useControl } from './P_1_C_45_control';

import { useComponentStyles } from './P_1_C_45_inside_UI';

import { useContainer, getNodeClasses } from './P_1_C_45_inside_utils';
