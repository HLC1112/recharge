<template>
  ...
  <div :style="componentStyle" :class="containerClasses">
    ...
    <span class="plane-title-text">TRIGGER</span>
...
import { IProps, IEmits, INode } from './P_1_C_26_inside_Obj';

import { useControl } from './P_1_C_26_control';

import { useComponentStyles } from './P_1_C_26_inside_UI';

import { useContainer, getNodeClasses } from './P_1_C_26_inside_utils';
