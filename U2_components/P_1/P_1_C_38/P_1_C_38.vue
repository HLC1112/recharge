<template>
  ...
  <div :style="componentStyle" :class="containerClasses">
    ...
    <span class="plane-title-text">服务器网关</span>
...
import { IProps, IEmits, INode } from './P_1_C_38_inside_Obj';

import { useControl } from './P_1_C_38_control';

import { useComponentStyles } from './P_1_C_38_inside_UI';

import { useContainer, getNodeClasses } from './P_1_C_38_inside_utils';
